  ...
  <div class="container mx-auto px-4">
    ...
    >
      <div>
          ...
          >
            ...
            <li>
              <div class="flex items-center">
                ...
                <a
                  href="#"
                  class="ms-1 text-sm font-medium text-gray-700 hover:text-red-600 dark:text-gray-400 dark:hover:text-white md:ms-2"
                  >Products</a
                >
              </div>
            </li>
        ...
        <h2 class="mt-3 text-4xl font-semibold text-gray-900 dark:text-white">
          Elite Euro OEM and Aftermarket Products
        </h2>
      </div>
...
const product = ref({
  name: "Shock Absorber, B4 OE Replacement",
  description:
    "Bilstein B4 OE Replacement gas pressure shock absorbers and struts are specifically engineered to be the best choice for maintaining the original ride quality of your vehicle, while meeting or exceeding OE standards. These dampers are the ideal choice for the driver looking to restore the original performance and handling of their vehicle, with the added benefit of world-famous Bilstein quality.",
  image:
    "https://img.wp-static.com/wam?type=image&asset=b2667f95-0527-4ca4-ad56-080cd8a85e59.JPG&size=1500",
  price: "$99.99",
});
</script>
