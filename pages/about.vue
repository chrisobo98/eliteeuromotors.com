    ...
    <section class="bg-white dark:bg-[#1d1d1d]">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="mx-auto px-4 text-center">
                ...
                <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400 mb-12">
        ...
        <div class="mt-16 sm:mt-20">
            <div class="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
                <div v-for="image in images" :key="image.src"
                    ...
                    :class="image.rotateClass">
                    <img :src="image.src" alt="" loading="lazy" class="absolute inset-0 h-full w-full object-cover" />
                </div>
            </div>
        </div>
            ...
            <div>
                ...
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-12 md:space-y-0">
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Family Owned</h3>
                        <p class="text-gray-500 dark:text-gray-400">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 dark:text-gray-400">
                            ...
                            leave our shop feeling confident and satisfied with the quality of
                            our work.
                        </p>
                    </div>
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Fair Prices</h3>
                        <p class="text-gray-500 dark:text-gray-400">
                            We believe in transparency and fairness, which is why we offer
                            competitive and transparent pricing for all our services. You can
                            trust that you’ll receive honest and upfront pricing without any
...
.card-wrapper::before {
    ...
    height: 300%;
    width: 250%;
    background: conic-gradient(rgba(255, 0, 0, 0.668) 0deg,
            rgba(255, 25, 25, 0.4) 0deg,
            transparent 80deg);
