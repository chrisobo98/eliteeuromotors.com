<template>
  <div class="relative z-50" @click.outside="handleClickOutside">
    ...
    >
      ...
      >
        {{ $t("home.notificationDropdown.header") }}
      </div>
      ...
      <div
        v-else
        class="py-6 px-4 text-center text-gray-500 dark:text-gray-400"
      >
        {{ $t("home.notificationDropdown.description") }}
      </div>
      ...
      >
        <div class="inline-flex items-center">
          ...
          {{ $t("home.notificationDropdown.view_all") }}
        </div>
      </NuxtLink>
    </div>
  </div>
