<template>
    <div class="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
      <form class="space-y-4" @submit.prevent="applyVoucher">
        <div>
          ...
          <input v-model="voucherCode" type="text" id="voucher" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" required />
        </div>
  ...
  export default {
    ...
    methods: {
      applyVoucher() {
        this.$emit('apply-voucher', this.voucherCode);
      }
    }
  };
  </script>
