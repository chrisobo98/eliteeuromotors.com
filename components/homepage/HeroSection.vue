<template>
  <section class="bg-white dark:bg-[#1d1d1d]">
    ...
    >
      ...
      >
        Welcome to Elite Euro Motor, Ocoee's premier destination for European
        auto care. Nestled in the heart of Florida, our family-owned business
      ...
      >
        <span class="font-semibold text-gray-400 uppercase"
          >SERVICING YOUR FAVORITE EUROPEAN CAR MODELS SINCE 2007</span
        >
        <div class="slider">
