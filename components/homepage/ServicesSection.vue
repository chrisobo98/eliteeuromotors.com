<template>
  <section>
    <h2 class="text-6xl text-left md:text-center font-bold my-5 md:my-8">Popular Products & Services</h2>
    <!-- Featured Products/Services -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
      <ServiceCard
        imgSrc="https://imagedelivery.net/Fe3MnThb4g2VRIhXmqnFdw/c52e6c7a-c35b-4bdb-e20c-d123fb58ee00/public"
        imgAlt="Tire Repair & Replacement"
    ...
    <!-- Additional Details -->
    <div
      class="grid grid-cols-1 col-span-4 md:grid-cols-2 lg:grid-cols-4 gap-4"
    >
      <DetailCard
    ...
    <h2
      class="text-6xl text-right my-5 md:my-8 md:text-center font-semibold text-gray-900 dark:text-white"
    >
