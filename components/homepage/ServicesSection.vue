<template>
  <section>
    <h3 class="text-5xl text-left md:text-center uppercase font-bold my-5 md:my-8">
    ...
    >
      <ServicePane
        ...
        title="Hardware"
        subtitle="OEM & aftermarket parts available"
      ...
      <ServicePane
        ...
        title="Accessories"
        subtitle="Selection of OEM accessories"
      ...
      <ServicePane
        ...
        title="Inspections"
        subtitle="Pre-Purchase & General Inspections"        
      ...
      <ServicePane
        ...
        title="Batteries"
        subtitle="Voltage and battery replacements"
    ...
    <div class="grid gap-4 justify-items-stretch sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-2 mx-auto md:mb-12">
      <AllServicesSection
