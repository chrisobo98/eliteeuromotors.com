    ...
    <img
      ...
      <div class="mt-4 md:mt-0">
        ...
        <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
          Create an account today to take full advantage of our app’s powerful
          features. Track your vehicle’s maintenance history, schedule service
          appointments with ease, and receive real-time updates and
          notifications on your vehicle’s status.
        </p>
        <ul
          class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400 list-disc pl-5 space-y-2"
        >
          <li>Comprehensive service history at your fingertips</li>
          <li>Exclusive access to maintenance reminders and updates</li>
